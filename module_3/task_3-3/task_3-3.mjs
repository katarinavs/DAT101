...
printOut("Days left until the epic release of 2XKO: " + diff);
}
...
printOut("The circumference of your circle is: " + omkrets.toFixed(3));
printOut("The diameter of your circle is: " + diameter.toFixed(3));
printOut("The area of your circle is: " + areal.toFixed(3));
}
radiusOfCircle(2);
printOut(newLine);
...
function myRectangle(height, width){
    let circ = 2 * (height + width);
    let area = width * height

printOut("Your square is " + height  + "m tall, and " + width + "m wide. ");
printOut("The circumference of your square is: " + circ + "m");
printOut("The area of your square is: " + area + "sq m");
}
myRectangle(7,5);
printOut(newLine);
...
function convertTemperature(aTemperature, aType){
    ...
    switch(aType){
        ...
        case ETemperatureType.Fahrenheit:
                printOut("Convert from Farenheit");
...
printOut(newLine);
const netPrice2 = calculateNetPrice(300, "food");
...
printOut(newLine);
const netPrice6 = calculateNetPrice(100, "goblins");
...
// Example usage:
modifyString("Hello friend", 40, "*", true); // Outputs: "Hello*****"
modifyString("HEY FRIEND", 40, "#", false); 
printOut(newLine);
